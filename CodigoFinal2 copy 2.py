...
def abrir_ventana_principal():
    ...
    def completarNoticia():
        ...
        if gurlbase == "https://www.ambito.com":
            import Sitio_Ambitos2
            list_dicc2=Sitio_Ambitos2.web_scraping(glisturl,gtextbusq,gurlbase)

        elif gurlbase == "https://www.eldestapeweb.com":
            import Sitio_Eldestape2
            list_dicc2=Sitio_Eldestape2.web_scraping(glisturl,gtextbusq,gurlbase)
