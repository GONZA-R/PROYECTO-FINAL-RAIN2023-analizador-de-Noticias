...
def abrir_ventana_principal():
    ...
    from funcionesfinal import url_bases
    ...
    def llenartextboxnoticoincidente(list_dicc):
        ...
        funcionesfinal.procesar_noticias(list_dicc)
        indice_invertido = funcionesfinal.crear_indice_invertido(list_dicc)
        noticias_diccionario = []
        noticias_diccionario=funcionesfinal.buscar_y_guardar_noticias(indice_invertido,valor_cargado)
